        ...
        <nav>
            <div class="heading">
                ...
                <div class="login-user">
                    <div class="cart">
                        <a href="#" class="cart-1"><i class="fa-solid fa-cart-shopping fa-2xl" style="color: #ffffff; padding: 23px 30px 23px 0;"></i></a>
                    </div>
                    <div class="users">
                        <a href="#" class="users-1"><i class="fa-solid fa-user fa-2xl" style="color: #ffffff; padding: 23px 15px 23px 14px;"></i></a>
                    </div>
                    <div class="user-actions">
                        <a href="view-profile.php">Xem thông tin</a><br>
